...
//   // const handleLoginByTU = async (e: React.FormEvent) => {
//   //   e.preventDefault();
//   //   setResult(null); // ล้าง error เก่าก่อน

//   //   try {
//   //     // ✅ เปลี่ยนจาก axios.post เป็น signIn ของ NextAuth
//   //     const res = await signIn("credentials", {
//   //       username,
//   //       password,
//   //       redirect: false, // เพื่อให้เราควบคุมการ push หน้าเอง
//   //     });

//   //     if (res?.error) {
//   //       // ถ้ามี Error (เช่น รหัสผิด หรือ API มธ. ล่ม)
//   //       setResult({ error: "Login failed: " + res.error });
//   //     } else if (res?.ok) {
//   //       // ถ้าผ่าน ให้ไปหน้าจองหอพัก
//   //       router.push("/book");
//   //       router.refresh(); // เพื่อให้อัปเดตสถานะ session ทันที
//   //     }
//   //   } catch (error: any) {
...
//       {/* กำหนดความกว้างและความสูงอัตราส่วนให้ใกล้เคียงกับรูปภาพ */}
