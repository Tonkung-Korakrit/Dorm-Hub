...
const RoomInfo = ({ booking }: RoomInfoProps) => {
  ...
  return (
    <div>
      ...
      <div className="bg-gray-100 rounded-2xl overflow-hidden border border-gray-200">
        <div className={`px-6 py-3 flex justify-between items-center ${(booking?.status === "PENDING_CORRECTION") ? "text-[12px]" : "text-[16px]"} font-black uppercase tracking-widest border-b ${getStatusStyles(booking.status)}`}>
